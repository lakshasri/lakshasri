...
<img src="https://capsule-render.vercel.app/api?type=waving&color=f2c4ce,e8b4c0,d4a0b0&height=130&section=header&animation=fadeIn&fontColor=6d3a47&fontSize=28" width="100%"/>
...
|  role    : cs undergrad  +  agent wrangler      |
|  loc     : bangalore, IN                        |
|  uptime  : 99.3%  (coffee dependent)            |
+-------------------------------------------------+
```
...
```
  ...
  building cool stuff          ████████░░  75%
  multi-agents rabbit hole     ██████░░░░  62%
